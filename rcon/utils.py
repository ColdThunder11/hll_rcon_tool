...
LONG_HUMAN_MAP_NAMES = {
    "foy_warfare": "佛依 Foy",
    "foy_offensive_ger": "佛依（德军进攻） Foy Offensive (GER)",
    "foy_offensive_us": "佛依（美军进攻）Foy Offensive (US)",
    "stmariedumont_warfare": "圣玛丽德蒙特 St Marie du Mont",
    'stmariedumont_off_us': "圣玛丽德蒙特（美军进攻） St Marie Du Mont Offensive (US)",
    'stmariedumont_off_ger': "圣玛丽德蒙特（德军进攻） St Marie Du Mont Offensive (GER)",
    "hurtgenforest_warfare_V2": "许特根森林 Hurtgen Forest",
    "hurtgenforest_offensive_ger": "许特根森林（德军进攻） Hurtgen Forest Offensive (GER)",
    "hurtgenforest_offensive_US": "许特根森林（美军进攻） Hurtgen Forest Offensive (US)",
    "utahbeach_warfare": "犹他海滩 Utah beach",
    "utahbeach_offensive_us": "犹他海滩（美军进攻） Utah Beach Offensive (US)",
    "utahbeach_offensive_ger": "犹他海滩（德军进攻） Utah Beach Offensive (GER)",
    "omahabeach_offensive_us": "奥马哈海滩（美军进攻） Offensive Omaha Beach",
    "stmereeglise_warfare": "圣梅尔埃格利斯 St Mere Eglise",
    "stmereeglise_offensive_ger": "圣梅尔埃格利斯（德军进攻） St Mere Eglise Offensive (GER)",
    "stmereeglise_offensive_us": "圣梅尔埃格利斯（美军进攻） St Mere Eglise Offensive (US)",
    "purpleheartlane_warfare": "紫心小道 Purple Heart Lane",
    "purpleheartlane_offensive_us": "紫心小道（美军进攻） Purple Heart Lane Offensive (US)",
    "purpleheartlane_offensive_ger": "紫心小道（德军进攻） Purple Heart Lane Offensive (GER)",
    "hill400_warfare": "400号高地 Hill 400",
    "hill400_offensive_US": "400号高地（美军进攻） Hill 400 Offensive (US)",
    "hill400_offensive_ger": "400号高地（德军进攻） Hill 400 Offensive (GER)",
    "carentan_warfare": "卡朗唐 Carentan",
    "carentan_offensive_us": "卡朗唐（美军进攻） Carentan Offensive (US)",
    "carentan_offensive_ger": "卡朗唐（德军进攻） Carentan Offensive (GER)",
    'kursk_warfare': "库尔斯克 Kursk",
    'kursk_offensive_rus': "库尔斯克（苏联进攻） Kursk Offensive (RUS)",
    'kursk_offensive_ger': "库尔斯克（德军进攻）Kursk Offensive (GER)",
    'stalingrad_warfare': "斯大林格勒 Stalingrad",
    'stalingrad_offensive_rus': "斯大林格勒（苏联进攻） Stalingrad Offensive (RUS)",
    'stalingrad_offensive_ger': "斯大林格勒（德军进攻） Stalingrad Offensive (GER)",
}
...
NO_MOD_SHORT_HUMAN_MAP_NAMES = {
    "foy_warfare": "佛依 Foy",
    "foy_offensive_us": "佛依（美军进攻）Foy (US)",
    "foy_offensive_ger": "佛依（德军进攻） Foy (GER)",
    "stmariedumont_warfare": "圣玛丽德蒙特 SMDM",
    ...
    "omahabeach_offensive_us": "奥马哈海滩（美军进攻） Omaha",
    ...
    "purpleheartlane_offensive_us": "紫心小道（美军进攻） PHL (US)",
    "purpleheartlane_offensive_ger": "紫心小道（德军进攻）PHL (GER)",
    "hill400_warfare": "400号高地 Hill400",
    "hill400_offensive_US": "400号高地（美军进攻） Hill400 (US)",
    "hill400_offensive_ger": "400号高地（德军进攻） Hill400 (GER)",
    "carentan_warfare": "卡朗唐 Carentan",
    "carentan_offensive_us": "卡朗唐（美军进攻） Carentan (US)",
    "carentan_offensive_ger": "卡朗唐（德军进攻） Carentan (GER)",
    'kursk_warfare': "库尔斯克 Kursk",
    'kursk_offensive_rus': "库尔斯克（苏联进攻） Kursk (RUS)",
    'kursk_offensive_ger': "库尔斯克（德军进攻）Kursk (GER)",
    'stalingrad_warfare': "斯大林格勒 Stalingrad",
    'stalingrad_offensive_rus': "斯大林格勒（苏联进攻） Stalingrad (RUS)",
