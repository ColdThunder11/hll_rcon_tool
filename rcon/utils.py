...
LONG_HUMAN_MAP_NAMES = {
    ...
    'kursk_warfare': "Kursk",
    'kursk_offensive_rus': "Offensive Kursk (RUS)",
    'kursk_offensive_ger': "Offensive Kursk (GER)",
    'stalingrad_warfare': "Stalingrad",
    'stalingrad_offensive_rus': "Offensive Stalingrad (RUS)",
    'stalingrad_offensive_ger': "Offensive Stalingrad (GER)",
    'stmariedumont_off_us': "Offensive St Marie du Mont (US)",
    'stmariedumont_off_ger': "Offensive St Marie du Mont (GER)",
}
